...
Point       TOP_TWO_FOURTHS;
Point       TOP_THREE_FOURTHS;
View        ACTION_BAR;
View        MAIN_MENU;
View        CONFIGURE_MENU;
View        FLIGHT_MENU;
...
void initialiseHackDroneDeclarations() {
  ...
  MAIN_MENU = new View("Main menu view");
  MAIN_MENU.add(new Label("Home", new Point(width/2, height/2)));
  ...
  CONFIGURE_MENU.add(new Label("Configuration", new Point(width/2, BUTTON_DEFAULT_DIMENSIONS.dims[1] + 10)));
